      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div ref={heroRef} className="relative z-10 text-center px-4">
          <div ref={titleRef} className="mb-4">
            <GlitchText speed={1} enableShadows={true} enableOnHover={false} className="text-5xl md:text-7xl font-bold font-['Orbitron'] tracking-wider text-white drop-shadow-2xl">
              ACCOMMODATION
            </GlitchText>
          </div>
          <p className="text-lg md:text-xl text-gray-300 font-mono tracking-widest uppercase mt-6">
