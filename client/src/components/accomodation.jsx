  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-primary selection:text-black">
      ...
      < div className="py-10 bg-black overflow-hidden" >
        <ScrollVelocity
          texts={['METALLUM 2026', 'ACCOMMODATION', 'COMFORT', 'IGNITE']}
          velocity={50}
          className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-white opacity-40 font-['Orbitron']"
        />
      </div >
